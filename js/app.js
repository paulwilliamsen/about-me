...
function questionOneGame() {
  userName = prompt('What would you like to be called today?');
...
function questionSevenGame() {
  ...
  if (answersCorrect === 0) {
    ...
    alert(userName + ', you got ' + answersCorrect + ' out of 7 correct. You might be the least worst.');
